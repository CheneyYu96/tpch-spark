...
configure_alluxio(){
	...
	flintrock run-command $cluster_name 'echo "fr.repl.interval=600" >> /home/ec2-user/alluxio/conf/alluxio-site.properties; echo "fr.parquet.info=false" >> /home/ec2-user/alluxio/conf/alluxio-site.properties; echo "fr.repl.policy.class=alluxio.master.repl.policy.BundleHottestKPolicy" >> /home/ec2-user/alluxio/conf/alluxio-site.properties;'
